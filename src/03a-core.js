...
var VERDICTS = [
  {min:100, a:"Nothing left here. Take the full practice exam next.",
  ...
  {min:50,  a:"About half. Back to the notes and flashcards for this chapter before testing again.",
  ...
  {min:0,   a:"Start with the notes and flashcards. Testing before the material is in place mostly measures frustration.",
   t:["You’re cheeks.","Cooked.","It’s so over.","Pack it up.","Nah bro.","Down bad.","In the trenches.","Lock in, bro.","Somebody come get him.","Bro guessed the whole thing.","That quiz would’ve had you in a headlock.","Not a single one landed, twin."]}
];
var REACT = {
